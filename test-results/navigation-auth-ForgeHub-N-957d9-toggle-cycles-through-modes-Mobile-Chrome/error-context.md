...
- Name: navigation-auth.spec.ts >> ForgeHub Navigation & Authentication Overhaul >> Theme toggle cycles through modes
- Location: e2e\navigation-auth.spec.ts:25:7
...
Locator: getByRole('button', { name: /Current theme is/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Current theme is/i })
